        ...
        <section className="flex flex-row items-center justify-center px-2 py-4  md:justify-center md:pt-10 md:px-6 max-w-6xl ">
          ...
          <div className=" w-2/5 text-left order-2 mb-14 md:mb-6 md:w-3/5 lg:w-3/4 md:py-6">
            <h1 className="text-[27px] md:text-2xl lg:text-3xl font-bold mb-8 md:mb-0 leading-none">
              ...
              <span className="text-white"> one paw</span> at{" "}
              <br className="md:hidden" />a time.
            </h1>
            ...
            <button className="bg-dark text-primary px-3 py-2 rounded-xl text-m md:text-base hover:duration-150 ease-in-out hover:shadow-lg duration-150 hover:text-white  cursor-pointer transition">
              Adopt now!
            </button>
          </div>
        </section>
